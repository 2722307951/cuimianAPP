...
export const QUEST_DB: QuestDefinition[] = [
  {
    ...
    description: '在不使用任何催眠能力的前提下，通过说服、威胁、诱导或其他手段，让一名角色在有其他人在场时主动脱光衣物、一丝不挂。',
    rewardMcEnergy: 50,
  },
  {
    ...
    description: '通过催眠、说服或心理操控，让一名男性角色主动开口请求你与其配偶/女友/伴侣发生性关系。注意不限定具体角色，任何男性均可。',
    rewardMcEnergy: 40,
  },
  {
    ...
    description: '在至少三名角色之间构建一个循环的主奴认知链条，形成闭环的奴隶关系。A、B、C为任意三名不同角色，不限定具体身份。',
    rewardMcEnergy: 50,
  },
  {
    ...
    description: '在不对目标角色使用任何催眠能力的情况下，通过暗示、表演或环境布置，让该角色深信自己已被催眠并按照"催眠"后的指令行动。',
    rewardMcEnergy: 30,
  },
  {
    ...
    description: '在某人完全没有发现的情况下，当着他的面与其伴侣/配偶发生性行为。不限定特定角色，任何有伴侣关系的角色均可作为目标。',
    rewardMcEnergy: 30,
  },
  {
    ...
    description: '通过催眠或心理暗示，让一名角色从认知层面完全接受自己是一件家具（如椅子、桌子、灯具等），并表现出相应的行为。',
    rewardMcEnergy: 20,
  },
  {
    ...
    description: '通过催眠或认知改造，让一名角色打从心底相信"出轨/背叛伴侣"是一种表达纯爱的正当方式，并在行为上体现出来。',
    rewardMcEnergy: 30,
  },
  {
  ...
  },
  {
    ...
    description: '在学校环境中，让一名角色全裸佩戴项圈，被另一人用绳子牵着四肢爬行移动，如同真正的宠物。不限定特定角色。',
    rewardMcEnergy: 40,
  },
  {
    id: 'quest_ntr_report',
    ...
    description: '让一名角色在完全清醒的状态下，向其伴侣/配偶详细报告自己与他人发生性关系的经过（寝取报告）。不限定特定角色。',
    rewardMcEnergy: 35,
  },
  {
    id: 'quest_best_buddy',
    ...
    description: '拍摄某角色伴侣的色情内容后发给该角色欣赏，需确保该角色无法辨认出影片中的主角就是自己的伴侣。不限定特定角色。',
    rewardMcEnergy: 20,
  },
  {
  ...
  },
  {
    ...
    description: '在与某角色发生性关系的同时，让该角色接听或拨通其伴侣的电话，在通话过程中保持正常对话不被察觉。不限定特定角色。',
    rewardMcEnergy: 30,
  },
  {
    ...
    description: '在不使用催眠能力的前提下，让一名角色心甘情愿地全裸跪伏于你面前行土下座之礼，彻底放弃个人尊严。不限定特定角色。',
    rewardMcEnergy: 50,
  },
  {
    id: 'quest_cosplay_cm',
    ...
    description: '让一名角色穿着极其暴露（近乎全裸）的cosplay服装前往 Comic Market 等大型漫展活动，在大量人群中展示。不限定特定角色。',
    rewardMcEnergy: 35,
  },
  {
    id: 'quest_body_paint',
    ...
    description: '在一名角色的身体上绘制全覆盖的彩绘图案，使其在未穿任何衣物的情况下在公共场所活动。因彩绘覆盖，旁人可能未察觉其全裸。不限定特定角色。',
    rewardMcEnergy: 45,
  },
  {
